...
_BUILTIN_PACKS: tuple[LibraryPack, ...] = (
    ...
    RAGAS_PACK, LLAMA_INDEX_PACK, DATASETS_PACK, TOKENIZERS_PACK, ACCELERATE_PACK, PEFT_PACK,
    ONNXRUNTIME_PACK, SAFETENSORS_PACK, OPTIMUM_PACK, SENTENCEPIECE_PACK, OPTUNA_PACK,
