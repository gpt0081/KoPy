...
_BUILTIN_PACKS: tuple[LibraryPack, ...] = (
    ...
    IR_MEASURES_PACK, RAGAS_PACK, LANGCHAIN_CORE_PACK, LLAMA_INDEX_PACK, HAYSTACK_PACK, OLLAMA_PACK, LITELLM_PACK, PYDANTIC_AI_PACK, PYPDF_PACK, DATASETS_PACK, TOKENIZERS_PACK,
