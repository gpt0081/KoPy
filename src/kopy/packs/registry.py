...
from .pydantic_ai import PYDANTIC_AI_PACK
from .pypdf import PYPDF_PACK
from .qdrant import QDRANT_PACK
from .ragas import RAGAS_PACK
from .ranx import RANX_PACK
from .rapidfuzz import RAPIDFUZZ_PACK
...
from .sqlite_vec import SQLITE_VEC_PACK
from .tantivy import TANTIVY_PACK
...
from .usearch import USEARCH_PACK
...
_BUILTIN_PACKS: tuple[LibraryPack, ...] = (
    ...
    FAISS_PACK, USEARCH_PACK, SQLITE_VEC_PACK, QDRANT_PACK, CHROMA_PACK, LANCEDB_PACK, BM25S_PACK, TANTIVY_PACK, RAPIDFUZZ_PACK, RANX_PACK,
    IR_MEASURES_PACK, RAGAS_PACK, LANGCHAIN_CORE_PACK, LLAMA_INDEX_PACK, HAYSTACK_PACK, OLLAMA_PACK, LITELLM_PACK, PYDANTIC_AI_PACK, OPENAI_AGENTS_PACK, PYPDF_PACK, DATASETS_PACK, TOKENIZERS_PACK,
    ACCELERATE_PACK, PEFT_PACK, ONNXRUNTIME_PACK, SAFETENSORS_PACK, OPTIMUM_PACK,
    SENTENCEPIECE_PACK, OPTUNA_PACK, MLFLOW_PACK, MATPLOTLIB_PACK, SCIPY_PACK, XGBOOST_PACK,
    LIGHTGBM_PACK, OPENCV_PACK,
)
