...
_BUILTIN_PACKS: tuple[LibraryPack, ...] = (
    ...
    TIMM_PACK, KORNIA_PACK, EINOPS_PACK, JAX_PACK, TRANSFORMERS_PACK, DATASETS_PACK,
    TOKENIZERS_PACK, ACCELERATE_PACK, PEFT_PACK, ONNXRUNTIME_PACK, SAFETENSORS_PACK,
    OPTIMUM_PACK, SENTENCEPIECE_PACK, OPTUNA_PACK, MLFLOW_PACK, MATPLOTLIB_PACK, SCIPY_PACK,
