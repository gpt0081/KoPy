...
_BUILTIN_PACKS: tuple[LibraryPack, ...] = (
    ...
    TORCHMETRICS_PACK, TRANSFORMERS_PACK, SENTENCE_TRANSFORMERS_PACK, FAISS_PACK,
    QDRANT_PACK, CHROMA_PACK, BM25S_PACK, RANX_PACK, IR_MEASURES_PACK, DATASETS_PACK,
    TOKENIZERS_PACK, ACCELERATE_PACK, PEFT_PACK, ONNXRUNTIME_PACK, SAFETENSORS_PACK,
    OPTIMUM_PACK, SENTENCEPIECE_PACK, OPTUNA_PACK, MLFLOW_PACK, MATPLOTLIB_PACK,
    SCIPY_PACK, XGBOOST_PACK, LIGHTGBM_PACK, OPENCV_PACK,
)
