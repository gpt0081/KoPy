...
_BUILTIN_PACKS: tuple[LibraryPack, ...] = (
    ...
    FAISS_PACK, QDRANT_PACK, CHROMA_PACK, LANCEDB_PACK, BM25S_PACK, RANX_PACK, IR_MEASURES_PACK,
    RAGAS_PACK, LLAMA_INDEX_PACK, HAYSTACK_PACK, DATASETS_PACK, TOKENIZERS_PACK, ACCELERATE_PACK,
    PEFT_PACK, ONNXRUNTIME_PACK, SAFETENSORS_PACK, OPTIMUM_PACK, SENTENCEPIECE_PACK, OPTUNA_PACK,
    MLFLOW_PACK, MATPLOTLIB_PACK, SCIPY_PACK, XGBOOST_PACK, LIGHTGBM_PACK, OPENCV_PACK,
)
